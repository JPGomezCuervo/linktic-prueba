CREATE TABLE IF NOT EXISTS item_audit_logs_old(
...
INSERT INTO item_audit_logs_old(id, item_id, operation, changes_json, actor_account_id, actor_name, actor_email, created_at)
SELECT id, item_id, operation, changes_json, actor_account_id, actor_name, actor_email, created_at
FROM item_audit_logs
WHERE operation IN ('create', 'update', 'delete', 'restore');

DROP TABLE item_audit_logs;

ALTER TABLE item_audit_logs_old RENAME TO item_audit_logs;
